			...
			children: [{
				...
				},
				{
					...
					children: [{
							//我的信息
							path: '/topic_lib',
							component: resolve => require(['../components/TopicLib.vue'], resolve),
							meta: {
								title: '题库'
							}
						},
						{
							//用户信息
							path: '/resource_lib',
							component: resolve => require(['../components/ResourceLib.vue'], resolve),
							meta: {
								title: '资源库'
							}
						},
						{
							//账号安全
							path: '/exercise_lib',
							component: resolve => require(['../components/ExerciseLib.vue'], resolve),
							meta: {
								title: '活动库'
							}
						}
